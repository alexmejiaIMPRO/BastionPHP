...
Read the full docs in `docs/` (generated):  
- `docs/01-getting-started.md` — quick start  
- `docs/02-guides.md` — common workflows and examples  
- `docs/03-config.md` — environment and config details  
- `docs/04-api.md` — API overview and core classes  
- `docs/REFERENCE.md` — exhaustive symbol reference  
- `docs/CHANGELOG.md`, `docs/CHEATSHEET.md` — changelog and cheatsheet
...
Full docs are generated under `docs/` and an HTML entrypoint `index.html` was created at the project root. Key docs:
- `docs/REFERENCE.md` — exhaustive file/class/function reference (machine-friendly).
- `docs/01-getting-started.md` & `docs/02-guides.md` — developer tutorials.
